      ...
      switch (trigger.getCondition()) {
        case CHANCE_COOLDOWN -> {
          ...
          switch (abilityEffect) {
            ...
            case CHAIN_DAMAGE -> abilityLore.append(ChatColor.WHITE).append("Deal ").append(abilityData[3]).append(" ").append(ChatColor.AQUA).append(TextFormatter.capitalizePhrase(type)).append(ChatColor.WHITE).append(" [").append(abilityData[2].equals("true") ? "Self] (" : "Target] (").append(" (").append(abilityData[4]).append("m)");
          }
        }
