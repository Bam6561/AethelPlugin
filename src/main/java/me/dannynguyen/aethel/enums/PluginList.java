...
public enum PluginList {
  ...
  PLAYERSTAT_CATEGORY_ACTIVITIES(List.of(
  ...
  PLAYERSTAT_CATEGORY_CONTAINERS(List.of(
  ...
  PLAYERSTAT_CATEGORY_DAMAGE(List.of(
  ...
  PLAYERSTAT_CATEGORY_INTERACTIONS(List.of(
