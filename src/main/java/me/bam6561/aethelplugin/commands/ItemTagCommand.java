 ...
 * <p>
 * Registered through {@link me.bam6561.aethelplugin.Plugin}.
 * <p>
 * Parameters:
 * <ul>
  ...
  private record Request(Player user, String[] args, ItemStack item) {
    ...
    private class TagModifier {
      ...
      private class TagSet {
        ...
        /**
         * Checks whether the {@link me.bam6561.aethelplugin.rpg.Equipment} {@link ActiveAbility active}
         * tag was formatted correctly before setting its tag and value.
         *
         * @param value tag value
         */
        ...
        /**
         * Sets an item's {@link me.bam6561.aethelplugin.rpg.Equipment} {@link ActiveAbility active} tag.
         *
         * @param value tag value
         */
