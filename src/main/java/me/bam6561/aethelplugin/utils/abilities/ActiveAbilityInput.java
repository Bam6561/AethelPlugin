package me.bam6561.aethelplugin.utils.abilities;
...
/**
 * Represents {@link me.bam6561.aethelplugin.rpg.abilities.ActiveAbility}
...
public class ActiveAbilityInput {
  ...
  /**
   * Sets {@link me.bam6561.aethelplugin.enums.rpg.abilities.ActiveAbilityType.Effect#BUFF}.
   *
  ...
  /**
   * Sets {@link me.bam6561.aethelplugin.enums.rpg.abilities.ActiveAbilityType.Effect#CLEAR_STATUS}.
   *
   * @return ability data if set correctly, otherwise null
   */
  @Nullable
  ...
  /**
   * Sets {@link me.bam6561.aethelplugin.enums.rpg.abilities.ActiveAbilityType.Effect#DISPLACEMENT}.
   *
   * @return ability data if set correctly, otherwise null
   */
  @Nullable
  ...
  /**
   * Sets {@link me.bam6561.aethelplugin.enums.rpg.abilities.ActiveAbilityType.Effect#DISTANCE_DAMAGE}.
   *
   * @return ability data if set correctly, otherwise null
   */
  @Nullable
  ...
  /**
   * Sets {@link me.bam6561.aethelplugin.enums.rpg.abilities.ActiveAbilityType.Effect#MOVEMENT}.
   *
   * @return ability data if set correctly, otherwise null
   */
  @Nullable
  ...
  /**
   * Sets {@link me.bam6561.aethelplugin.enums.rpg.abilities.ActiveAbilityType.Effect#POTION_EFFECT}.
   *
   * @return ability data if set correctly, otherwise null
   */
  @Nullable
  ...
  /**
   * Sets {@link me.bam6561.aethelplugin.enums.rpg.abilities.ActiveAbilityType.Effect#PROJECTION}.
   *
   * @return ability data if set correctly, otherwise null
   */
  @Nullable
  ...
  /**
   * Sets {@link me.bam6561.aethelplugin.enums.rpg.abilities.ActiveAbilityType.Effect#SHATTER}.
   *
   * @return ability data if set correctly, otherwise null
   */
  @Nullable
  ...
  /**
   * Sets {@link me.bam6561.aethelplugin.enums.rpg.abilities.ActiveAbilityType.Effect#TELEPORT}.
   *
   * @return ability data if set correctly, otherwise null
   */
  @Nullable
